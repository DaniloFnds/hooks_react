...
const UseMemo = (props) => {
    ...
    //'e tipo usar o useEffect abaixo,
    //quando uma funcao demora mto pra retornar, ele guarda o valor memorizada da funcao, qd ocorrer mudan'cas nas dependencias
